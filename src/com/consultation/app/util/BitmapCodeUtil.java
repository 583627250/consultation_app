...
public class BitmapCodeUtil {
    ...
    private static final char[] CHARS={'2', '3', '4', '5', '6', '7', '8', '9', '1', '0'};

    private static BitmapCodeUtil bmpCode;

    public static BitmapCodeUtil getInstance() {
        if(bmpCode == null)
            bmpCode=new BitmapCodeUtil();
        return bmpCode;
    }
    ...
    private void randomTextStyle(Paint paint) {
        ...
        skewX = random.nextBoolean() ? skewX : -skewX; paint.setTextSkewX(skewX);//float类型参数，负数表示右斜，整数左斜
