...
public class RecommendMiddleFilterView extends RelativeLayout implements ViewBaseAction {
	...
	public RecommendMiddleFilterView(Context context, String items[]) {
		super(context);
		this.items = items;
		init(context);
	}

	public RecommendMiddleFilterView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public RecommendMiddleFilterView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
