...
import com.consultation.app.activity.ForgetPwdActivity;
...
public class MineFragment extends Fragment implements OnClickListener {
    ...
    private TextView header_text, phone_text, tip_text, updatePwd_text, pay_text, share_text, invitation_text, set_text,
            feedback_text, update_text, help_text, about_text;

    private LinearLayout info_layout, updatePwd_layout, pay_layout, share_layout, invitation_layout, set_layout, feedback_layout,
            update_layout, help_layout, about_layout, info_text_layout, info_icon_layout;
...
//        info_text_layout = (LinearLayout)mineLayout.findViewById(R.id.mine_my_info_text_layout);
//        info_text_layout.setOnClickListener(this);
//        
//        info_icon_layout = (LinearLayout)mineLayout.findViewById(R.id.mine_my_info_icon_layout);
//        info_icon_layout.setOnClickListener(this);
    }
...
//                startActivityForResult(new Intent(mineLayout.getContext(), SelectPicActivity.class), 0);
                break;
            ...
            case R.id.mine_my_update_pwd_layout:
                // 去忘记密码
                startActivity(new Intent(mineLayout.getContext(), ForgetPwdActivity.class));
