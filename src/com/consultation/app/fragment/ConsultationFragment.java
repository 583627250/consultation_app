...
public class ConsultationFragment extends Fragment {
    ...
    public static ConsultationFragment getInstance(Context context) { 
        mContext = context;
    ...
    private void InitImageView() {
        ...
        offset = (screenW / titleCount - bmpW) / 2;// 计算偏移量
    ...
    public class MyOnPageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            case 0:
                t1.setTextColor(Color.BLUE);
                t2.setTextColor(Color.parseColor("#525252"));
                t3.setTextColor(Color.parseColor("#525252"));
                t4.setTextColor(Color.parseColor("#525252"));
                t5.setTextColor(Color.parseColor("#525252"));
                if (currIndex == 1) {
            ...
            case 1:
                ...
                t1.setTextColor(Color.parseColor("#525252"));
                t3.setTextColor(Color.parseColor("#525252"));
                t4.setTextColor(Color.parseColor("#525252"));
                t5.setTextColor(Color.parseColor("#525252"));
                if (currIndex == 0) {
    ...
    private void InitViewPager() {
        ...
        System.out.println(new ConsultationListAllFragment());
        listViews.add(new ConsultationListAllFragment());
        listViews.add(new ConsultationListWaitFragment());
        listViews.add(new ConsultationListDoingFragment());
        listViews.add(new ConsultationListHistoryFragment());
        listViews.add(new ConsultationListFileFragment());
