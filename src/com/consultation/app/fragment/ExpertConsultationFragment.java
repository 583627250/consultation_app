...
public class ExpertConsultationFragment extends Fragment {
    ...
    private void InitViewPager() {
        ...
        listViews.add(new ExpertConsultationAllFragment());
        listViews.add(new ExpertConsultationWaitFragment());
        listViews.add(new ExpertConsultationDoingFragment());
        listViews.add(new ExpertConsultationDiscussionFragment());
        listViews.add(new ExpertConsultationHistoryFragment());
