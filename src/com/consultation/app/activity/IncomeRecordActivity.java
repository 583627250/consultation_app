...
public class IncomeRecordActivity extends Activity implements OnLoadListener {
    ...
    private void initDate() {
        ...
        OpenApiService.getInstance(this).getMyAcountIncomeRecord(mQueue, parmas, new Response.Listener<String>() {
            ...
            public void onResponse(String arg0) {
                ...
                try {
                    ...
                    if(responses.getInt("rtnCode") == 1) {
                        JSONArray infos=responses.getJSONArray("incomes");
                        for(int i=0; i < infos.length(); i++) {
                            ...
                            payRecordTo.setType(info.getString("tp"));
                        ...
                        Toast.makeText(IncomeRecordActivity.this, responses.getString("rtnMsg"), Toast.LENGTH_SHORT).show();
                        ...
                        startActivity(new Intent(IncomeRecordActivity.this, LoginActivity.class));
                    }else{
                        Toast.makeText(IncomeRecordActivity.this, responses.getString("rtnMsg"),
            ...
            public void onErrorResponse(VolleyError arg0) {
                CommonUtil.closeLodingDialog();
                Toast.makeText(IncomeRecordActivity.this, "网络连接失败,请稍后重试", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        ((PullToRefreshLayout)findViewById(R.id.my_acount_pay_list_refresh_view))
            .setOnRefreshListener(new OnRefreshListener() {
                ...
                public void onRefresh(final PullToRefreshLayout pullToRefreshLayout) {
                    ...
                    parmas.put("page", "1");
                    parmas.put("rows", "10");
                    OpenApiService.getInstance(IncomeRecordActivity.this).getMyAcountIncomeRecord(mQueue, parmas,
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null) {
                convertView=LayoutInflater.from(IncomeRecordActivity.this).inflate(R.layout.pay_record_list_item, null);
