                ...
                OpenApiService.getInstance(ForgetPwdActivity.this).getForgetMobileUsable(mQueue, parmas,
                    new Response.Listener<String>() {
                        ...
                        public void onErrorResponse(VolleyError arg0) {
                            CommonUtil.closeLodingDialog();
                            Toast.makeText(ForgetPwdActivity.this, "网络连接失败,请稍后重试", Toast.LENGTH_SHORT).show();
                        }
                    });
            }
        });
        ...
        commit_btm.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pwd_edit.getText().toString().length() < 6) {
                    Toast.makeText(ForgetPwdActivity.this, "密码格式不正确,请输入6-20位字母或数字的密码!", Toast.LENGTH_SHORT).show();
                    return;
                }
                parmas.put("mobile_ph", phone_edit.getText().toString());
