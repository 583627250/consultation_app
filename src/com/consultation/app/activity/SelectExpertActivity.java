...
public class SelectExpertActivity extends Activity {
    ...
    private void initDate() {
        editor = new SharePreferencesEditor(SelectExpertActivity.this);
        if(editor.get("select_expert_history",null) != null && !"".equals(editor.get("select_expert_history",null))){
            isHasHistory = true;
            String[] historys = editor.get("select_expert_history",null).split(",");
    ...
    private void initView() {
        ...
        deleteText.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                editor.put("select_expert_history", "");
                historyList.clear();
        ...
        search_text.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(null != editTextString && !"".equals(editTextString)){
                    if(editor.get("select_expert_history",null) == null || "".equals(editor.get("select_expert_history",null))){
                        editor.put("select_expert_history", editTextString);
                    }else{
                        for(String temp: editor.get("select_expert_history",null).split(",")) {
                            if(temp.equals(editTextString)){
                                isHave = true;
                            }
                        }
                        if(!isHave){
                            editor.put("select_expert_history", editor.get("select_expert_history",null)+","+editTextString);
                        }
                        isHave = false;
                    }
                    Intent intent = new Intent(SelectExpertActivity.this, SelectExpertResultActivity.class);
                    intent.putExtra("title", "选择专家");
   ...
   private class MyAdapter extends BaseAdapter {
       ...
       public View getView(int position, View convertView, ViewGroup parent) {
           if(convertView == null) {
               convertView=LayoutInflater.from(SelectExpertActivity.this).inflate(R.layout.search_recommend_list_item, null);
