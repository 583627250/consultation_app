...
public class MyTitleActivity extends Activity {
    ...
    private void initHospitalDatas() {
        SelectHospitalDB myDbHelper=new SelectHospitalDB(MyTitleActivity.this);
        try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null) {
                convertView=LayoutInflater.from(MyTitleActivity.this).inflate(R.layout.province_list_item, null);
            }
