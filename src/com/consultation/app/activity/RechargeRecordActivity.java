...
public class RechargeRecordActivity extends Activity implements OnLoadListener {
    ...
    private void initDate() {
        ...
        OpenApiService.getInstance(this).getMyAcountRechargeRecord(mQueue, parmas, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError arg0) {
                CommonUtil.closeLodingDialog();
                Toast.makeText(RechargeRecordActivity.this, "网络连接失败,请稍后重试", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        ((PullToRefreshLayout)findViewById(R.id.my_acount_recharge_list_refresh_view))
            .setOnRefreshListener(new OnRefreshListener() {
                ...
                public void onRefresh(final PullToRefreshLayout pullToRefreshLayout) {
                    ...
                    parmas.put("page", "1");
                    parmas.put("rows", "10");
                    OpenApiService.getInstance(RechargeRecordActivity.this).getMyAcountRechargeRecord(mQueue, parmas,
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null) {
                convertView=LayoutInflater.from(RechargeRecordActivity.this).inflate(R.layout.recharge_record_list_item, null);
