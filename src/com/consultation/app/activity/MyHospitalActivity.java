...
public class MyHospitalActivity extends Activity {
        ...
        search_text_btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(null != contents.getText().toString() && !"".equals(contents.getText().toString())) {
                    ...
                    Toast.makeText(MyHospitalActivity.this, "请输入医院名称", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void initHospitalDatas() {
        myDbHelper=new SelectHospitalDB(MyHospitalActivity.this);
        try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null) {
                convertView=LayoutInflater.from(MyHospitalActivity.this).inflate(R.layout.province_list_item, null);
            }
