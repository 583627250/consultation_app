...
public class MyDepartmentActivity extends Activity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(!isSelectDepartment) {
                    ...
                    if(departmentBranchs.size() == 0) {
                        h.onSuccess(departments.get(position).getName() + "," + departments.get(position).getId(), 1);
                        finish();
                    } else {
                        temp.clear();
    ...
    private void initHospitalDatas() {
        SelectHospitalDB myDbHelper=new SelectHospitalDB(MyDepartmentActivity.this);
        try {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView == null) {
                convertView=LayoutInflater.from(MyDepartmentActivity.this).inflate(R.layout.province_list_item, null);
            }
